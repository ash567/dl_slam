...
do_mask_rcnn = False
do_mask_rcnn2 = True
if do_mask_rcnn2 and bs != 1:
    print 'setting batch size back to 1 to do rcnn'
    bs = 1
...
if dataset_name == 'VKITTI':
    ...
    y0 = 187.0
    x0 = 620.5
    dataset_location = "datasets/vkitti/singles_w_everything6/"
