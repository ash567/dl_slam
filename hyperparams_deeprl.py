...
# odo_init = "02x128x512_1.0e-05_D4_F4_O4_p10.00+r_VKITTI_val"
...
#----------- general hypers -----------#
bs = 1 # this is overwritten if do_train = False
lr = 1e-5
...
#----------- seg hypers -----------#
seg_coeff = 0.0 # not (re-)implemented yet 

#----------- rules ----------#
do_object_depth_rule = True #requires VKITTI!
do_bbox2cuboid = True
object_depth_rule_coeff = 1.0

do_normals_rule = True
...
if dataset_name == 'VKITTI':
    ...
    y0 = 187.0
    x0 = 620.5
    dataset_location = "datasets/vkitti/singles_w_everything4/"
